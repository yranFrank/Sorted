...
t=t.replace('const incomeTotals = useMemo(function () { return categoryTotals(allTransactions.filter(function (item: any) { return item.debit_credit == ''credit''; }), workspace.categories.income); }, [allTransactions, workspace]);','const incomeTotals = useMemo(function () { return categoryTotals(allTransactions.filter(function (item: any) { return item.debit_credit == ''credit''; }), workspace.categories.income); }, [allTransactions, workspace]);\n  const identifiedTransactions = useMemo(function () { return reviewTransactions.filter(function (item: any) { return item.status == ''reviewed''; }); }, [reviewTransactions]);\n  const pendingTransactions = useMemo(function () { return reviewTransactions.filter(function (item: any) { return item.status != ''reviewed''; }); }, [reviewTransactions]);') 
